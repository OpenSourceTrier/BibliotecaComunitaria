...
public class MontarPratoActivity extends Activity {
    
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.montar_prato_layout);
        Aplicacao.Iniciar(this);

        
        //Inicializando sons
        final MediaPlayer mpArroz = MediaPlayer.create(this, R.raw.arroz);
        final MediaPlayer mpBife = MediaPlayer.create(this, R.raw.bife);
        final MediaPlayer mpCoxa = MediaPlayer.create(this, R.raw.frango);
        final MediaPlayer mpFeijao = MediaPlayer.create(this, R.raw.feijao);
        final MediaPlayer mpMacarrao = MediaPlayer.create(this, R.raw.macarrao);
